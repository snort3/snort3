...
namespace
{
class NHttpInspect : public ConversionState
{
public:
    NHttpInspect(Converter& c) : ConversionState(c) { }
    ~NHttpInspect() { }
...
bool NHttpInspect::convert(std::istringstream& data_stream)
{
    std::string keyword;
...
bool NHttpInspect::add_decode_option(std::string opt_name,  std::istringstream& stream)
{
    int val;
