...
static ThreshData thData[] = {
   ...
   ,{ 100, 100, THD_TRK_SRC, THD_TYPE_LIMIT,       1,  1, IP_ANY, THD_TOO_MANY_THDOBJ, 0, nullptr }
   ,{ 100, 101, THD_TRK_SRC, THD_TYPE_LIMIT,       1,  1, IP_ANY, 0, 0, nullptr }
   ,{ 100, 101, THD_TRK_DST, THD_TYPE_LIMIT,       1,  1, IP_ANY, THD_TOO_MANY_THDOBJ, 0, nullptr }

    // type checks (dup gid,sid allowed with suppress)
   ,{ 100, 110, THD_TRK_SRC, THD_TYPE_THRESHOLD,   1,  1, IP_ANY, 0, 0, nullptr }
   ,{ 100, 110, THD_TRK_SRC, THD_TYPE_THRESHOLD,   1,  1, IP_ANY, THD_TOO_MANY_THDOBJ, 0, nullptr }
   ,{ 100, 120, THD_TRK_SRC, THD_TYPE_BOTH,        1,  1, IP_ANY, 0, 0, nullptr }
   ,{ 100, 120, THD_TRK_SRC, THD_TYPE_BOTH,        1,  1, IP_ANY, THD_TOO_MANY_THDOBJ, 0, nullptr }
   ,{ 100, 130, THD_TRK_SRC, THD_TYPE_SUPPRESS,    1,  1, IP4_SRC, 0, 0, nullptr }
   ,{ 100, 130, THD_TRK_SRC, THD_TYPE_SUPPRESS,    1,  1, IP4_SRC, 0, 0, nullptr }
   ,{ 100, 140, THD_TRK_SRC, THD_TYPE_LIMIT,       1,  1, IP_ANY, 0, 0, nullptr }
   ,{ 100, 140, THD_TRK_SRC, THD_TYPE_LIMIT,       1,  1, IP_ANY, THD_TOO_MANY_THDOBJ, 0, nullptr }
