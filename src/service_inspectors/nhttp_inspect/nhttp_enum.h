...
typedef enum { SEC__NOTCOMPUTE=-4, SEC__NOTPRESENT=-1, SEC_HEADER = 2, SEC_BODY, SEC_CHUNKHEAD, SEC_CHUNKBODY, SEC_TRAILER, SEC_DISCARD, SEC_CLOSED, SEC_ABORT } SectionType;
